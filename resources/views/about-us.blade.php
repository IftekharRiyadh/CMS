                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              ...
                              <li><a href="./about-us">About Us</a></li>
                                  ...
                                  <li><a href="./thinking">We Are Working With</a></li>
                                  <li><a href="./trainning">Our trainning Partner</a></li>
        ...
        <article class="accordion">
          ...
          <article class="accordion">
            ...
            <article class="accordion">
              ...
              <article class="accordion">
                <div class="accordion-head">
                    <span>Capacity And Training Scenario</span>
                    <span class="icon">
                        <i class="icon fa fa-chevron-right"></i>
                    </span>
                </div>
                ...
                <article class="accordion">
                  <div class="accordion-head">
                      <span>Office & training Space</span>
                      <span class="icon">
                          <i class="icon fa fa-chevron-right"></i>
                      </span>
                  </div>
